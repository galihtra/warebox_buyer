...
class productListDetail2 extends StatefulWidget {
  const productListDetail2({super.key});

  @override
  State<productListDetail2> createState() => _productListDetailState2();
}

class _productListDetailState2 extends State<productListDetail2> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFFFCFCFC),
